...
<div class="container">
    <form action="{{Route('bookmarks.store')}}" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea id="memo" name="memo" class="w-full h-96 p-4 text-xs leading-none resize-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="ご自由にご記入ください"></textarea>
        </div>
        <br>
        <div class="ml-auto">
