    ...
    <form action="{{Route('bookmarks.store')}}" method="POST">
        ...
        <table class='table table-striped'>
            ...
            <tr>
                ...
                <td>
                    <div class="mb-6">
                        <input id="bookmark" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" type="text" name="bookmark" value="{{ old('url') }}">
                    </div>
                </td>
            </tr>
            <tr>
                    ...
                    <div class="mb-6">
                        <div class="flex">
                            <select id="isURL" class="appearance-none block pl-4 pr-8 py-3 mb-2 text-sm bg-white border rounded" name="isURL">
                                ...
                                <option value="{{$is_url -> id}}">{{$is_url -> division}}</option>
                                @endforeach
                            </select>
                            <div class="pointer-events-none transform -translate-x-full flex items-center px-2 text-gray-500">
                                <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20">
        ...
        <div class="mb-4">
            ...
            <textarea id="memo" name="memo" class="w-full h-96 p-4 text-xl leading-none resize-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="ご自由にご記入ください"></textarea>
        </div>
        <br>
        <div class="ml-auto">
