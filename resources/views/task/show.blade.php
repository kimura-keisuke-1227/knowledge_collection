                    ...
                    <div class="mb-6">
                        <div class="flex">
                            <select id="status" class="appearance-none block pl-4 pr-8 py-3 mb-2 text-sm bg-white border rounded" name="status">
                                ...
                                <option value="{{$task_status -> id}}" @if ($task_status -> id == $task->status)
                                    selected
                                    @endif
                                    >{{$task_status -> division}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-6">
                        <div class="flex">
                            <select id="importance" class="appearance-none block pl-4 pr-8 py-3 mb-2 text-sm bg-white border rounded" name="importance">
                                ...
                                <option value="{{$importance -> id}}" @if ($importance -> id == $task->status)
                                    selected
                                    @endif
                    ...
                    <div class="mb-6">
                        <div class="flex">
                            <select id="urgency" class="appearance-none block pl-4 pr-8 py-3 mb-2 text-sm bg-white border rounded" name="urgency">
                                ...
                                <option value="{{$urgency -> id}}" @if ($urgency -> id == $task->urgency)
                                    selected
                                    @endif
